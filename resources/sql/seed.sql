...
---------------------------------------------------- INVITATION ---------------------------------------------------- 
insert into invitation (event_id, invited_id, inviter_id, message, date, accepted) values ( 2, 5, 20, 'Vem a este evento fantástico!', '10-03-2020', TRUE);
