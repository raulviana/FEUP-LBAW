...
CREATE TABLE "event" (
    ...
    local_id INTEGER NOT NULL REFERENCES "local" (local_id) ON UPDATE SET NULL,
    photo_id INTEGER REFERENCES photo (photo_id) ON UPDATE SET NULL,
