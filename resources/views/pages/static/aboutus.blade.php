        ...
        <div class="row text-center row-cols-4">
            <div class="col d-flex justity-content-center">
                <div class="card text-center">
                    <img class="card-img-topimg-fluid" src= {{ Storage::url('team_photos/raul.jpg') }} alt="Raul Photo">
                    <div class="card-body">
            ...
            <div class="col d-flex justity-content-center">
                <div class="card text-center">
                    <img class="card-img-topimg-fluid" src={{ Storage::url('team_photos/claudia.jpg') }} alt="Claudia Photo">
                    <div class="card-body">
            ...
            <div class="col d-flex justity-content-center">
                <div class="card text-center">
                    <img class="card-img-topimg-fluid" src={{ Storage::url('team_photos/leonor.jpg') }} alt="Leonor Photo">
                    <div class="card-body">
            ...
            <div class="col d-flex justity-content-center">
                <div class="card text-center">
                    <img class="card-img-topimg-fluid" src={{ Storage::url('team_photos/miguel.jpg') }} alt="Miguel Photo">
                    <div class="card-body">
