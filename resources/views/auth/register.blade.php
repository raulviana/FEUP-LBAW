            ...
            <div class="col-md-12 flex-column justify-content-center">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <!-- Uploaded image area-->
                  <div class="image-area mt-4 border img-thumbnail"><img id="imageResult" src="#" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                  <!-- Upload image input-->
                  <div class="input-group mb-3 px-2 py-1 rounded-pill bg-white shadow-sm">
                    <input id="upload-photo" type="file" onchange="readImage(this);" class="form-control border-0">
                  </div>
                </div>
