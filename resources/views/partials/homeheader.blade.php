    ...
    <div class="row">
        ...
        <div class="col container">
              ...
              <div style="background: #e0d426;" class="overlay">
                <div onclick="location.href='tags/sculpture';" id="overlay-text" class="text">Click to search for <b>#SCULPTURE</b></div>
              </div>
        </div>
        ...
        <div class="col container">
            ...
            <div style="color: #4c3ac2;" class="text-centered">#DANCE</div>
              <div style="background: #4c3ac2;" class="overlay">
                <div onclick="location.href='tags/dance';" id="overlay-text" class="text">Click to search for <b>#DANCE</b></div>
              </div>
        </div>
        ...
        <div class="col container">
            ...
            <div style="color: #db27d5;" class="text-centered">#MUSIC</div>
              <div style="background: #db27d5;" class="overlay">
                <div onclick="location.href='tags/music';" id="overlay-text" class="text">Click to search for <b>#MUSIC</b></div>
              </div>
        </div>
        ...
        <div class="col container">
            ...
            <div style="color: #2a97b5;" class="text-centered">#COMEDY</div>
              <div style="background: #2a97b5;" class="overlay">
                <div onclick="location.href='tags/comedy';" id="overlay-text" class="text">Click to search for <b>#COMEDY</b></div>
              </div>
        </div>
        ...
        <div class="col container">
            ...
            <div style="color: #43b52a;"  class="text-centered">#LITERATURE</div>
              <div style="background: #43b52a;" class="overlay">
                <div onclick="location.href='tags/literature';" id="overlay-text" class="text">Click to search for <b>#LITERATURE</b></div>
              </div>
        </div>
        ...
        <div class="col container">
            ...
            <div style="color: #000FFF;" class="text-centered">#OTHERS</div>
              <div style="background: #000FFF;" class="overlay">
                <div onclick="location.href='tags/others';" id="overlay-text" class="text">Click to search for <b>#OTHERS</b></div>
              </div>
        </div>
    </div>
