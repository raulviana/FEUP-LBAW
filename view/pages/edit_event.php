...
<div class="container">
    <div class="row profile justify-content-center">
        ...
        <br><br>
            ...
            <div class="row">
                <div class="col">          
                    <input class="form-control form-control-md" type="text" placeholder="Event Title">
         ...
         <br>
            ...
            <div class="row">
                <div class="col">
                    <p id="event-info"> 📌 <b>Where:</b> <input class="form-control form-control-sm" type="text" placeholder="Location..."> </p>
                </div>
                <div class="col">
            ...
            <div class="row">            
                <div style="font-size:0.65rem;" class="col">
                    ...
                    <label class="checkbox-inline mr-2"><input type="checkbox" value="" checked> <button id="tag-button" type="button" class="btn theater-tag">Theater</button></label>
                    ...
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn dance-tag">Dance</button></label>
                    
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn music-tag">Music</button></label>
                            
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn paintings-tag">Paintings</button></label>                    
                    
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn comedy-tag">Comedy</button></label>                    
                    
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn literature-tag">Literature</button></label>
                    
                    <label class="checkbox-inline mr-2"><input type="checkbox" value=""><button id="tag-button" type="button" class="btn others-tag">Others</button></label>
